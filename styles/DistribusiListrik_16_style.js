var size = 0;
var placement = 'point';
function categories_DistribusiListrik_16(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case '1.276.948':
...
var style_DistribusiListrik_16 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Distribusi");
    var labelText = "";
    size = 0;
...
var style = categories_DistribusiListrik_16(feature, value, size, resolution, labelText,
